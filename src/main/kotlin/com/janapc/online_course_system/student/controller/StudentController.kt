...
class StudentController(
	...
	): Page<StudentResponse> = studentService.findAll(name, active, pageable)
	...
	fun create(
		@Valid @RequestBody student: CreateStudentRequest,
	): StudentResponse = studentService.create(student)
	...
	fun findCourses(
		@PathVariable id: Long,
	): List<CourseSummaryResponse> = enrollmentService.findCoursesByStudent(id)
