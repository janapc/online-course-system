...
class StudentE2ETest {
    ...
    private fun MockHttpServletRequestBuilder.bearer(token: String): MockHttpServletRequestBuilder = this.header(
    ...
    inner class ProtectedRoutesTests {
        ...
        fun shouldReturn200WhenValidTokenProvided() {
            ...
            mockMvc.perform(get("/students").bearer(token))
    ...
    inner class ValidationTests {
        ...
        fun shouldReturn404ForMissingStudent() {
            ...
            mockMvc.perform(get("/students/999999").bearer(token))
