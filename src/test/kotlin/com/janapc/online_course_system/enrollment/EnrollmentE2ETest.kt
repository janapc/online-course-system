...
class EnrollmentE2ETest {
    ...
    @Test
    @DisplayName("Should execute full enrollment flow: Register/Login -> Create Student -> Create Course -> Enroll -> Verify Enrolled Courses -> Prevent Duplicate Enrollment")
    fun shouldExecuteFullEnrollmentFlow() {
        ...
        val studentResult = mockMvc.perform(
            post("/students")
                .bearer(token)
